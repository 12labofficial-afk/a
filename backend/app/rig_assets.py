...
SLOT_KEYWORDS = {
    ...
    "left_palm_3_cup": [["left", "cup"], ["left", "mug"], ["left", "palm", "3"], ["left", "hand", "3"], ["left", "hand"]],
    "right_palm_1": [["right", "palm", "1"], ["right", "hand", "1"], ["right", "point"]],
    "right_palm_2": [["right", "palm", "2"], ["right", "hand", "2"]],
    "right_hand_sword": [["right", "sword"], ["right", "prop"], ["right", "palm", "3"], ["right", "hand", "3"], ["right", "hand"]],
...
PIVOT_AT_TOP = {
    ...
    "left_palm_1", "left_palm_2", "left_palm_3_cup", "right_palm_1", "right_palm_2", "right_hand_sword",
